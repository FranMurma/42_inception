...
# Asegura que los archivos en /var/www/ tengan los permisos y propietarios correctos
# Esto es importante para que Nginx y PHP-FPM puedan acceder y ejecutar los archivos correctamente
